...
- Pin daemonkit v0.19.1 so a terminalized worker claim tears down the owning
  daemon runtime instead of leaving an unusable process alive.

## [0.30.0] - 2026-07-24

### Changed

- Pin daemonkit v0.18.0 and dispatch its mandatory trust-verifier child before
  command parsing in the executable and test binaries that own daemon runtimes.
...
- Pinned the daemon lifecycle, process ownership, and wire runtime to daemonkit v0.15.0.
